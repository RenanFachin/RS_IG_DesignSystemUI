...
var {
  ...
  // theme => variáveis que vamos utilizar
  theme: {
    colors,
    fontSizes,
    fontWeights,
...
function Avatar2(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AvatarContainer, { size, children: [
...
var CheckboxContainer = styled(Checkbox.Root, {
  ...
  alignItems: "center",
  border: "2px solid $gray900",
  // Estilizando com base nas propriedades
  '&[data-state="checked"]': {
...
var CheckboxIndicator = styled(Checkbox.Indicator, {
  ...
  width: "$4",
  height: "$4",
  // Aplicando os keyframes com base nas propriedades
  '&[data-state="checked"]': {
...
var Steps = styled("div", {
  ...
  gap: "$2",
  marginTop: "$1",
  // Passando o size como tamanho do total de colunas
